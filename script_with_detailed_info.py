...
from time import sleep  # Optional, simulate progress
...
def write_to_excel(data):
    ...
    sheet.append(["Server", "CPU Model", "CPU Frequency (MHz)", "Memory Speed (MHz)", "Memory Size (GB)", "Number of Cores"])
